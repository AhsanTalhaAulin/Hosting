	...
	<div class="container main-entry">
		...
		<blockquote><p>Why choose Harris Web Works to update your Magento website? Because we’ll implement the most current technologies to make your site an industry leader. Our services include&nbsp;<a href="website-dev.phpintegrating-magento-erp-system/">integrating Magento and ERP systems</a>, <a  target="_blank" href="https://www.harriswebworks.com/website-hosting-administration/">hosting</a>, <a  target="_blank" href="https://www.harriswebworks.com/website-administration/magento-services/">ongoing administration</a>, <a  target="_blank" href="https://www.harriswebworks.com/online-marketing/">marketing</a>, and strategizing to continually improve and grow the store. Plus, we’re accessible and easy to work with!&nbsp;<a href="index.php#contact-us">Ask us questions</a>.</p></blockquote>
		...
		<blockquote class="wp-block-quote"><p><a  target="_blank" href="https://www.harriswebworks.com/free-ecommerce-b2b-analysis/">Get a FREE eCommerce Business Assessment</a> – learn how you can manage orders, product data, customer information, and accounting processes in <strong>one seamless system</strong>.</p></blockquote>
		...
		</a><a  target="_blank" href="https://www.harriswebworks.com/case-studies/SYNC-Connect-WP.pdf">SYNC Connection White Paper</a></p>
